...
For a broader accessibility testing playbook, consult the project's accessibility guidance or current official accessibility documentation.
...
For any of those, use Playwright Component Testing (component test in a real browser) or the project's full E2E test suite.
