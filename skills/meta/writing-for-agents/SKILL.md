...
metadata:
  origin: vendored
  upstream: https://skills.sh/mattpocock/skills/writing-for-agents
  note: Verbatim upstream copy; the repository is the canonical mirror, global installs are refreshed from it.
---
