...
- Before planning or rewriting README copy, or auditing its content, you must read [references/content-architecture.md](references/content-architecture.md) for plain-language writing, content folding, alerts, and links to dedicated documents. Asset-only work does not require this reference unless it includes README copy changes separately authorized by the user.
